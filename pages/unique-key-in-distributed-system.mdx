...
>
> 결제 시스템, 원장 관리 등과 같은 서비스에는 반드시 필요하지는 않습니다. 하지만, 요청이 늘어나서 Duplicated Key 관련 예외발생확률이 높아지기 시작한다면 고민을 해야 할 것 같습니다. 만약 기본키의 Range 를 늘리면서 생성시각에 따른 정렬이 가능한 기본키를 원한다면 도입을 고려하게 될 것 같습니다. <br/>
>
